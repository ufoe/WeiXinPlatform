...
//参数设置
define('SOFT_VERSION', '1商业版');
define('SOFT_RELEASE', $version);
define('ROOT_PATH', dirname(__FILE__).'/../');//网站根目录
define('SOFT_NAME', '【微商家】微信营销'.SOFT_VERSION);
define('DBCHARSET','UTF8');//编码 分为 UTF8 GBK
//----------------------语言包
$lang = array(
'license'=>'<div class="license"><h1>系统安装说明</h1>
				<p>感谢您选择【微商家】微信营销系统,基于 PHP + MySQL 的技术开发，商业版开源绿色全部源码开放。</p>
				<p>为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的说明：</p>
			<strong>一、本程序为【微商家】商业版系统绿色开源程序</strong>
			    <p></p>
			<strong>二、安装事项 </strong>
				<b><p>1、填写您服务器上的数据库地址，mysql数据库名称，用户名，密码</p>
				<p>2、数据库前缀保持为tp_不要随意改动</p>
				<p>3、管理员用户名用户名一定要写成admin</p></b>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 【微商家】商业版系统安装程序',
...
?>
			<div class="footer">
			    <p>Copyright © 2011-2013 【微商家】版权所有</p>
			</div>
		</div>
		</div>
		</body>
