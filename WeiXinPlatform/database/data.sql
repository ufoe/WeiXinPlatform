...
CREATE TABLE IF NOT EXISTS `tp_follow` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='关注表' AUTO_INCREMENT=97 ;
...
CREATE TABLE IF NOT EXISTS `tp_member_card_create` (
  ...
  PRIMARY KEY (`id`),
  KEY `token` (`token`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=13777 ;
