		...
		<div class="banner">
			<ul>
					<li class="pic-intro" >
						<div class="text">
							<h4>
								已有<font>65786</font>商家入驻<?php echo C('site_name');?>，微信营销 如此简单
							</h4>
...
<div class="content clearfix">
			...
			<div style="width:600px; margin:0 auto; position:relative;">
				...
				<div class="notice">
					<label>
						<a href="javascript:;" onclick="javascript:$('#notice_mask').show(), $('#notice_message').show();" title=""><?php echo C('site_name');?>播报：微风帮助文档更新啦！！！</a>
...
<!--公告信息-->
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[2013-08-08]<?php echo C('site_name');?>微信营销系统全线升级，欢迎新老客户咨询体验，我们会一如既往的为您提供更优质的服务!</br></br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[2014-01-16]
	<?php echo C('site_name');?>微信营销系统使用帮助文档已经更新，请进入“帮助中心”，点击<a href="./tpl/User/default/common/images/cart_info/wfhelp.rar" class="green">下载帮助文档</a>！！！</br>
	</div>
	</div>
