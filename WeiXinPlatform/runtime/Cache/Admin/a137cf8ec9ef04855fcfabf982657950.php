...
<tr> 
      <td  height="48" align="right"><strong>百度云存储 BUCKET：</strong></td>
      <td><input type="text" name="up_bucket" value="<?php echo C('up_bucket');?>" class="ipt" size="45" /><span></span>
    </td>
    </tr>
    <tr> 
      <td  height="48" align="right"><strong>api key</strong></td>
      <td><input type="text" name="up_form_api_key" value="<?php echo C('up_form_api_key');?>" class="ipt" size="45" /><span></span>
    </td>
    </tr>

     <tr> 
      <td  height="48" align="right"><strong>secret key</strong></td>
