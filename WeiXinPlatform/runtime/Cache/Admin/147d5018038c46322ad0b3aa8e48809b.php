...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
      ...
      <td><input type="text" name="email_server" value="<?php echo C('email_server');?>" class="ipt" size="45" />
      <span>&nbsp;&nbsp;例：微商家</span>
	  </td>
    </tr>
	 <tr> 
	...
	<!--<tr> 
	 ...
	 <tr> 
      ...
      <td><input type="text" name="email_user" value="<?php echo C('email_user');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://www.weshangjia.com</span>
    </tr> 
	<tr> 
