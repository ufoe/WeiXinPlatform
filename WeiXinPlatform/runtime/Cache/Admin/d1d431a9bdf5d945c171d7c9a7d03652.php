...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
      ...
      <td><input type="text" name="site_name" value="<?php echo C('site_name');?>" class="ipt" size="45" />
      <span>&nbsp;&nbsp;例：微商家</span>
	  </td>
    </tr>
	 <tr> 
	 ...
	 <tr> 
      ...
      <td><input type="text" name="site_url" value="<?php echo C('site_url');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://www.weshangjia.com</span>
    </tr>  
	<tr> 
      <td  height="48" align="right"><strong>机器人名称：</strong></td>
      <td><input type="text" name="site_my" value="<?php echo C('site_my');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://www.weshangjia.com</span>
    </tr> 
	<tr> 
	...
	<tr> 
      ...
      <td><input type="text" name="site_email" value="<?php echo C('site_email');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:QQ:server@.cn</span>
    </tr>
	<tr> 
	...
	<tr> 
      ...
      <?php echo C('copyright');?></textarea><span>&nbsp;&nbsp;例:微商家版权所有</span>
    </tr>
