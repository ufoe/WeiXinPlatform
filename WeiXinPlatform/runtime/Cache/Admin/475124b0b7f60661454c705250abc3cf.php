...
<meta name="keywords" content="<?php echo C('site_name');?>-后台管理系统" />
<meta name="description" content="<?php echo C('site_name');?>-后台管理系统" />
  ...
  <tr>
	...
	<div class="top">
    	<a href="/" class="logo" title="首页">首页</a>
		 <div class="login">
			<li>您好：<b><?php echo (session('username')); ?></b> ，欢迎使用【微商家】微信营销系统！</li>	
			<li><a href="<?php echo C('site_url');?>" target="_blank">访问首页</a></li>
			<li><a href="<?php echo C('site_url');?>/" target="_blank">登陆前台</a></li>
...
<p class="fr"> Copyright &copy; 2012-2013 【微商家】版权所有  </p>
</div></td>
  </tr>
</table>
</body>
