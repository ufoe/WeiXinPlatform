...
<div class="content" style="width:920px; background:none; margin-left:275px; border:none; margin-bottom:30px;" >          <div class="cLineB"><h4>关键词触发第三方接口</h4>
...
<thead>
	<tr>
	  ...
	  <td>
		<input class="radio" type="radio" name="type" value="1" <?php if($api['type'] == 1): ?>checked<?php endif; ?>>微信标准接口（标准xml）<br>  
		<input class="radio" type="radio" name="type" value="2" <?php if($api['type'] == 2): ?>checked<?php endif; ?>>  文本类型接口  <br>
