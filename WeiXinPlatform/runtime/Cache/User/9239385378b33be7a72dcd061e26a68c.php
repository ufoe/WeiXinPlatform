...
<div class="cLineB">
<h4>“<?php echo ($thisForm["name"]); ?>”微调研数据列表 <?php if($page): ?>(<?php echo ($page); ?>)<?php endif; ?> &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U('Weidiaoyan/index',array('token'=>$token));?>">返回</a> </h4>
...
<td class="norightborder"><a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Weidiaoyan/infoDelete',array('id'=>$item['id'],'token'=>$token));?>');">删除</a></td>
