...
<TR>
  ...
  <TD rowspan="7" valign="top">
	  <div style="margin-left:20px">
		<img id="pic1_src" src="<?php if($vo['starpicurl'] == 0): echo C('site_url');?>/tpl/Wap/default/common/css/guajiang/images/activity-lottery-start.jpg<?php else: echo ($vo["starpicurl"]); endif; ?>" width="373px" >	
		<br />
		<input class="px"  name="starpicurl" value="<?php echo C('site_url');?>/tpl/Wap/default/common/css/guajiang/images/activity-lottery-start.jpg"   onclick="document.getElementById('pic1_src').src=this.value;" id="pic1" style="width:363px;"  />
		<br />
  		...
  		<tbody>
  			<tr>
  				...
  				<td><input type="input" class="px" id="endtite" value="<?php if($vo['endtite'] == ''): ?>幸运大转盘活动已经结束了<?php else: echo ($vo["endtite"]); endif; ?>" name="endtite" style="width:400px" />
  					<br />
  					请不要多于50字! </td>
  				<td rowspan="4" valign="top"><div style="margin-left:20px"><img  id="pic2_src" src="<?php if($vo['endpicurl'] == 0): echo C('site_url');?>/tpl/Wap/default/common/css/guajiang/images/activity-lottery-end.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  width="373px"/> <br />
  					<input class="px" id="pic2"  name="endpicurl" value="<?php echo C('site_url');?>/tpl/Wap/default/common/css/guajiang/images/activity-lottery-end.jpg"  onclick="document.getElementById('pic2_src').src=this.value;"  style="width:363px;"  />
  					<br />
