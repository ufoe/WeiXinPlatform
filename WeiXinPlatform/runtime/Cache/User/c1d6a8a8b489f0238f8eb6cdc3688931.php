...
<div class="cLineB">
<h4>“<?php echo ($thisForm['name']); ?>”填写项管理 </h4>
<a href="<?php echo U('Weidiaoyan/index',array('token'=>$token));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Weidiaoyan/inputAdd',array('token'=>$token,'formid'=>$thisForm['id']));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<td class="norightborder"><a href="<?php echo U('Weidiaoyan/inputSet',array('id'=>$item['id'],'token'=>$token));?>">修改</a>&nbsp;&nbsp;<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Weidiaoyan/inputDelete',array('id'=>$item['id'],'token'=>$token));?>');">删除</a></td>
