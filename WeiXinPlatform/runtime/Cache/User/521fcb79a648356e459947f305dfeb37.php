              ...
              <TBODY>
               <TR>
                ...
                <TR style="display:none">
                  ...
                  <TD><input class="px"  name="pic" id="pic" value="" style="width:580px;"  />  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a>
</TD>
                </TR>
               <TR>
