               ...
               <tr>
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <td><input type="text"  name="picurl"  id="picurl" value="<?php echo ($taobao["picurl"]); ?>"   class="px" tabindex="1" size="80">   <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('picurl',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picurl')">预览</a></td>
                </tr>
                <tr>
