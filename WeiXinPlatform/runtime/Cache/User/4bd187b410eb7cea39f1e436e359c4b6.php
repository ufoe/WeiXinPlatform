...
<div class="cLineB">
 ...
 <div class="cLineB">
<div class="pageNavigator left"><strong>此相册地址：<a href="<?php echo C('site_url');?>/index.php?g=Wap&m=Photo&a=plist&token=<?php echo ($token); ?>&id=<?php echo ($_GET['id']); ?>" class="green"><?php echo C('site_url');?>/index.php?g=Wap&m=Photo&a=plist&token=<?php echo ($token); ?>&id=<?php echo ($_GET['id']); ?></a></strong></div>
<div class="clr"></div>
</div>
...
<tr>
	...
	<td>
		...
		<input class="px" style="width:250px;" type="text" name="picurl" id="picurl" value=""  /> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('picurl',1500,1000,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picurl')">预览</a>
...
<tr>
	...
	<td><div class="cateimg"></div><input class="px"  style="width:250px;"   type="text"   name="picurl" id="picurl<?php echo ($i); ?>" value="<?php echo ($photo["picurl"]); ?>"  /> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('picurl<?php echo ($i); ?>',1500,1000,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picurl<?php echo ($i); ?>')">预览</a></td>
