	...
	<form class="form" method="post" action="" enctype="multipart/form-data">
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				...
				<tr>
					<th>接口类型：</th>
					<td><select name="type"><option value="0" <option value="1" <?php if($config["type"] == 1): ?>selected="selected"<?php endif; ?>>手机网站支付</option></select>&nbsp;&nbsp;<a href="https://b.alipay.com/order/productDetail.htm?productId=2013080604609688" target="_blank"><img src="<?php echo RES;?>/images/help.png" class="vm helpimg" title="帮助"></a></td>
				</tr>
				<tr>
