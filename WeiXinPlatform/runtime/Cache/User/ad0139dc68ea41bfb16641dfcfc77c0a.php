...
<TR>
  ...
  <TD><input type="input" class="px" id="img" value="" name="img" style="width:500px" >  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('img',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('img')">预览</a> 建议图片(宽720高400)  </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
