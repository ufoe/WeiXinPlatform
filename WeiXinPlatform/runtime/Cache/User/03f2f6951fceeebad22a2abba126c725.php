            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                ...
                <tr>
                  ...
                  <td><input type="text" required="" class="px" name="smsuser" value="<?php echo ($info["smsuser"]); ?>" tabindex="1" size="25">
                  </td>
                </tr>
				<tr>
				...
				<tr>
                  ...
                  <td><input type="radio" value="1" checked="checked" name="smsstatus"/>开启 <input type="radio" value="0" name="smsstatus"/>关闭
                  </td>
                </tr>
				<div>
				<input type="hidden" required="" class="px" name="wxname" value="<?php echo ($info["wxname"]); ?>" tabindex="1" size="25">
				<input type="hidden" required="" title="无法修改，您可以联系管理员" name="wxid" value="<?php echo ($info["wxid"]); ?>" class="px" tabindex="1" size="25" style="color:#DDD;">
