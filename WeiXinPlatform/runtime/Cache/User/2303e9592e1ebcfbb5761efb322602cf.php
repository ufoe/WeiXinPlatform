	...
	<div id="Content" >
        ...
        <div class="content" style="width:920px; background:none; margin-left:275px; border:none; margin-bottom:30px;" >
          <div class="cLine">
			...
			<a href='/index.php?g=User&m=Wedding&a=add' title='新增微喜贴' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/product/add.png" class="vm" />新增微喜贴</a>
...
<TH class="norightborder">操作</TH>
         ...
         <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><TR>
                  ...
                  <TD><?php echo ($list["man"]); ?>/<?php echo ($list["woman"]); ?></TD>
                     <TD><?php echo ($list["password"]); ?></TD>
                     <TD>喜帖<?php echo ($list["id"]); ?></TD>
                      <TD><a  class="green" href="index.php?g=User&m=Wedding&a=photo&id=<?php echo ($list["id"]); ?>" >喜帖图片</a> </TD>
                   <TD class="norightborder"><a href="index.php?g=User&m=Wedding&a=info&id=<?php echo ($list["id"]); ?>" >查看名单</a>　<a href="index.php?g=User&m=Wedding&a=edit&id=<?php echo ($list["id"]); ?>" >编辑喜帖</a>　<a href="javascript:drop_confirm('您确定要删除吗?', 'index.php?g=User&m=Wedding&a=del&id=<?php echo ($list["id"]); ?>');">删除</a></TD>
