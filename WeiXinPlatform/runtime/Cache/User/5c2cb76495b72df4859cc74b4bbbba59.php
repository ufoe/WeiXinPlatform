			...
			<tbody>
				<tr>
					...
					<td valign="top">商家logo外链地址(图片尺寸100x100)<br>
						<input type="input" class="px" id="logo" name="logo" value="<?php echo ($info["logo"]); ?>" style="width:250px;" onblur="document.getElementById('logo_src').src=document.getElementById('logo').value;">  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('logo',200,200,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('logo')">预览</a>
					</td>
					<td rowspan="4" valign="top">&nbsp;</td>
					<td rowspan="4" valign="top"><img id="logo_src" class="logo" src="<?php echo ($info["logo"]); ?>" width="100px" height="100px"></td>
				</tr>
				<tr>
