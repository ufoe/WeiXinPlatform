...
<tr>
<th>相册头部图片外链地址:</th>
<td><input type="text" name="picurl" id="picurl" value="" class="px" style="width:400px;">   <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('picurl',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picurl')">预览</a> <button type="submit" name="homesubmit" value="true" class="btnGreen vm"><strong>修改</strong></button></td>
</tr></tbody></table>
                            </form>
</div>
<div class="cLine">
