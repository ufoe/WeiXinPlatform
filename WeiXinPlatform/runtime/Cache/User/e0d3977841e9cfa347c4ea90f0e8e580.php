...
<TH class="norightborder">操作</TH>
              ...
              <TBODY>
                <TR></TR>
                  ...
                  <TD>
				  <?php if($list['status'] == 0): ?>未开始<?php else: ?>已经开始<?php endif; ?>
                  ...
                  <TD>刮刮卡 <?php echo ($list["id"]); ?></TD>
				   ...
				   <a href="
				   <?php if($list['status'] != 0): ?>javascript:drop_confirm('你确定要结束活动吗，结束后不可再开启本活动!', 'index.php?g=User&m=Guajiang&a=setdes&id=<?php echo ($list["id"]); ?>');<?php else: ?>index.php?g=User&m=Guajiang&a=setinc&id=<?php echo ($list["id"]); endif; ?>">
