		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
					...
					<td><input type="text" name="title" value="<?php echo ($wedding["title"]); ?>" class="px" style="width:550px;"></td>
				</tr>
				<tr>
					<th width="120"><span class="red">*</span>关键词：</th>
					<td><input type="text" name="keyword" value="<?php echo ($wedding["keyword"]); ?>" class="px" style="width:550px;"><br/> <span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。
</td>
				</tr>
<tr>
					<th width="120"><span class="red">*</span>喜帖封面：</th>
					<td>
                    	<img id="toppic" src="<?php if($wedding['coverurl'] == ''): ?>http://bcs.duapp.com/baeimgs/Tnh1ROgm93.png<?php else: echo ($wedding["coverurl"]); endif; ?>" style="max-height: 100px;">
                        <br />
                      <input class="px"  name="coverurl" value="<?php if($wedding['coverurl'] == ''): ?>http://bcs.duapp.com/baeimgs/Tnh1ROgm93.png<?php else: echo ($wedding["coverurl"]); endif; ?>"   onclick="document.getElementById('toppic').src=this.value;" style="width:550px;">	
                   <br/>  封面默认大小720*400
</td>
				</tr>
<tr>
					...
					<td>
                    	<img id="openpic" src="<?php if($wedding['openpic'] == ''): ?>http://bcs.duapp.com/baeimgs/jNuxaj1cAj.jpg<?php else: echo ($wedding["openpic"]); endif; ?>" style="width: 180px; height: 180px;">
                        <br />
                      <input class="px"  name="openpic" value="<?php if($wedding['openpic'] == ''): ?>http://bcs.duapp.com/baeimgs/jNuxaj1cAj.jpg<?php else: echo ($wedding["openpic"]); endif; ?>"   onclick="document.getElementById('openpic').src=this.value;" style="width:550px;">	
...
<tr>
					...
					<td>
                    	<img id="pic" src="<?php if($wedding['picurl'] == ''): ?>http://bcs.duapp.com/baeimgs/2cDQtFbl75.jpg<?php else: echo ($wedding["picurl"]); endif; ?>" style="width: 40px; height: 40px;">
                        <br />
                      <input class="px"  name="picurl" value="<?php if($wedding['picurl'] == ''): ?>http://bcs.duapp.com/baeimgs/2cDQtFbl75.jpg<?php else: echo ($wedding["picurl"]); endif; ?>"   onclick="document.getElementById('pic').src=this.value;" style="width:550px;">	
                   <br/> 默认40x40,显示在喜帖主页
</td>
				</tr>
				<tr>
					<th><span class="red">*</span>新郎名字：</th>
					<td><input type="text" name="man" value="<?php echo ($wedding["man"]); ?>" class="px" style="width:550px;"></td>
				</tr>
				<tr>
					<th><span class="red">*</span>新娘名字：</th>
					<td><input type="text" name="woman" value="<?php echo ($wedding["woman"]); ?>" class="px" style="width:550px;"></td>
				</tr>
				<tr>
					<th></th>
					<td>
                    <input type="radio" name="who_first" value="1" <?php if($wedding['who_first'] == 1): ?>checked<?php endif; ?>>新郎名字在前
                    <input type="radio" name="who_first" value="2" <?php if($wedding['who_first'] == 2): ?>checked<?php endif; ?>>新娘名字在前
                    </td>
				</tr>
				<tr>
					<th><span class="red">*</span>联系电话：</th>
					<td><input type="text" name="telphone" value="<?php echo ($wedding["telphone"]); ?>" class="px" style="width:550px;"><br/> 如021-88888888</td>
				</tr>
				<tr>
					<th><span class="red">*</span>婚宴日期：</th>
					<td><input type="text" name="statdate" id="statdate" value="<?php if($wedding['statdate'] != ''): echo (date("Y-m-d H:i:s",$wedding["statdate"])); else: echo date('Y-m-d H:i:s',mktime(0, 0, 0, date("m") , date("d"), date("Y"))); endif; ?>" onClick="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss' })"></td>
				</tr>
				<tr>
					<th><span class="red">*</span>宴席地址：</th>
					<td><input type="text" name="address" value="<?php echo ($wedding["address"]); ?>" class="px" style="width:550px;"></td>
				</tr>
				<tr>
					<th><span class="red">*</span>经纬地址：</th>
					<td>经度 <input type="text" id="longitude"  name="lng" size="14" class="px" value="<?php echo ($wedding["lng"]); ?>" /> 纬度 <input type="text"  name="lat" size="14" id="latitude" class="px" value="<?php echo ($wedding["lat"]); ?>" /> <a href="###" onclick="setlatlng($('#longitude').val(),$('#latitude').val())">在地图中查看/设置</a></td>
				</tr>
				<tr>
					<th>喜帖视频：</th>
					<td><input type="text" name="video" value="<?php echo ($wedding["video"]); ?>" class="px" style="width:550px;"><p>支持优酷视频地址如;http://v.youku.com/v_show/id_XNjI4ODk5NDQ4.html <br /> 腾讯fash视频地址：如http://static.video.qq.com/TPout.swf?vid=v0119s27wd5&auto=0 <br /> 也支持mp4和ogg 格式地址 http://www.w3school.com.cn/example/html5/mov_bbb.mp4 </p></td>
				</tr>
				<tr>
					<th>背景音乐：</th>
					<td>
					...
					<option value="1.mp3" <?php if($wedding['mp3url'] == '1.mp3'): ?>selected="selected"<?php endif; ?>>今天你要嫁给我</option>
					<option value="2.mp3" <?php if($wedding['mp3url'] == '2.mp3'): ?>selected="selected"<?php endif; ?>>婚礼进行曲</option>
					<option value="3.mp3" <?php if($wedding['mp3url'] == '3.mp3'): ?>selected="selected"<?php endif; ?>>恋爱</option>
					<option value="4.mp3" <?php if($wedding['mp3url'] == '4.mp3'): ?>selected="selected"<?php endif; ?>>柔美的</option>
					<option value="5.mp3" <?php if($wedding['mp3url'] == '5.mp3'): ?>selected="selected"<?php endif; ?>>我爱你</option>
					<option value="6.mp3" <?php if($wedding['mp3url'] == '6.mp3'): ?>selected="selected"<?php endif; ?>>I Wanna Be With You</option>
					<option value="7.mp3" <?php if($wedding['mp3url'] == '7.mp3'): ?>selected="selected"<?php endif; ?>>Nothing'S Gonna Change My Love For You</option>
					<option value="8.mp3"  <?php if($wedding['mp3url'] == '8.mp3'): ?>selected="selected"<?php endif; ?>>爱是喜欢你(何洁)</option>
					<option value="9.mp3"  <?php if($wedding['mp3url'] == '9.mp3'): ?>selected="selected"<?php endif; ?>>明天我要嫁给你了(周华健)</option>
					<option value="10.mp3"  <?php if($wedding['mp3url'] == '10.mp3'): ?>selected="selected"<?php endif; ?>>最重要的决定(范玮琪)</option>
					<option value="11.mp3"  <?php if($wedding['mp3url'] == '11.mp3'): ?>selected="selected"<?php endif; ?>>I Love You</option>
					<option value="12.mp3"  <?php if($wedding['mp3url'] == '12.mp3'): ?>selected="selected"<?php endif; ?>>Wake Up Call</option>
					<option value="13.mp3"  <?php if($wedding['mp3url'] == '13.mp3'): ?>selected="selected"<?php endif; ?>>Could This Be Love</option>
					</select>
                    </td>
				</tr>
				<tr>
					<th><span class="red">*</span>密码：</th>
					<td><input type="text" name="password" value="<?php echo ($wedding["password"]); ?>" class="px" style="width:550px;"><br/> 设置微信上查看来宾名单的验证密码</td>
				</tr>
				<tr>
					<th width="120"><span class="red">*</span>想要给朋友说的话：</th>
					<td><textarea style="width:560px;height:75px" name="word" id="word" class="px"><?php if($wedding["word"] == ''): ?>亲爱的朋友，我要结婚了，希望能在我的婚礼上得到你的祝福，并祝愿你也幸福。<?php else: echo ($wedding["word"]); endif; ?></textarea><br/>最多填写120个字</td>
				</tr>
				<tr>
					<th><span class="red">*</span>二维码图片地址：</th>
					<td><input type="text" name="qr_code" value="<?php echo ($wedding["qr_code"]); ?>" class="px" style="width:550px;"><br>默认100x100,显示在喜帖底部</td>
				</tr>

				<tr>
					<th><span class="red">*</span>底部版权：</th>
					<td><input type="text" name="copyrite" value="<?php echo ($wedding["copyrite"]); ?>" class="px" style="width:550px;"><br/> 底部版权限制在二十个字以内</td>
				</tr>
