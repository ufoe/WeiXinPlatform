...
<div class="cLineB">
<h4 class="left">微调研(<?php echo ($page); ?>) </h4>
...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Weidiaoyan/add',array('token'=>$token));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<tr>
<th class="select"></th>
<th width="160">微调研名称</th>
<th width="160">关键词设置</th>
...
<td class="norightborder"><a href="<?php echo U('Weidiaoyan/infos',array('id'=>$item['id'],'token'=>$token));?>">微调研数据</a>&nbsp;&nbsp;<a href="<?php echo U('User/Weidiaoyan/inputs',array('id'=>$item['id'],'token'=>$token));?>">填写项管理</a>&nbsp;&nbsp;<a href="<?php echo U('Weidiaoyan/set',array('id'=>$item['id'],'token'=>$token));?>">修改</a>&nbsp;&nbsp;<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Weidiaoyan/del',array('id'=>$item['id'],'token'=>$token));?>');">删除</a></td>
