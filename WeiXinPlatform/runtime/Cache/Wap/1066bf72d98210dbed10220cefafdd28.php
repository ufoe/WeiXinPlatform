...
<title>请在此留言</title>
    ...
    <!--[if lte IE 9]><script src="<?php echo RES;?>/js/liuyan/watermark.js"></script><![endif]-->
	<!--[if IE 7]><link href="<?php echo RES;?>/css/liuyan/font_awesome_ie7.css" rel="stylesheet" /><![endif]-->
</head>
