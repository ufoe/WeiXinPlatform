...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/allcss/addnew65/iscroll.css" />
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/allcss/addnew65/wz.css" />
...
<div id="cate5">
	<ul class="mainmenu">
<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo ($vo["url"]); endif; ?>">
				<div class="menubtn">
					<div class="menumesg">
						<div class="menuimg">
							<div class="menuimg2">
